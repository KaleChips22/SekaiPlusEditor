...
const MenuBar = ({ isMac }: { isMac: boolean }) => (
  <div className="flex-1 w-full bg-neutral-800 text-neutral-200 flex items-center justify-start gap-1">
    ...
    <div className="flex items-center justify-end">
      <div
        className="aspect-square flex items-center justify-center hover:bg-neutral-700 text-xl p-1"
        style={{
      ...
      <div
        className="aspect-square flex items-center justify-center hover:bg-red-700 text-xl p-1"
        style={{
          height: `${titleBarHeight}px`,
        }}
        onClick={() => {
